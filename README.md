...
- Нужен полный исследовательский фон по ERC3, источникам и стратегиям: `ERC3_RU_REPORT.md`
...
## Как читать этот репозиторий агенту

Не читайте всё подряд.

1. Сначала этот `README.md`.
2. Затем ровно один профильный документ из `docs/`.
3. Переходите к коду только после выбора нужного маршрута.
4. К `ERC3_RU_REPORT.md` идите только если нужен полный контекст соревнования, а не просто изменение обёртки.
