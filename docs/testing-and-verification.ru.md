...
Если вы попали сюда напрямую: `AGENTS.md` помогает агенту выбрать маршрут, `README.md` даёт обзор проекта, а `docs/project-map.ru.md` показывает, где лежит нужный код.
